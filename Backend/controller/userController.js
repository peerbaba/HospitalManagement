...
//   // 🕵️‍♂️ 3️⃣ Check duplicate registration
//   const isRegistered = await User.findOne({ email });
//   if (isRegistered) {
//     return next(
//       new ErrorHandler(
...
//   // ☁️ 4️⃣ Upload to Cloudinary correctly
//   const cloudinaryResponse = await cloudinary.v2.uploader.upload(
//     String(docAvtar.tempFilePath)+String(docAvtar.name), // ✅ only tempFilePath, not +name
//     {
//       folder: "doctors", // optional folder
//     }
//   );
//   console.log(cloudinaryResponse,'cloudinaryResponse')
